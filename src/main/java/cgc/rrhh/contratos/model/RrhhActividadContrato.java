...
@NamedQueries({
    ...
    , @NamedQuery(name = "RrhhActividadContrato.findByActividadesByContrato", query = "SELECT a FROM RrhhActividadContrato r INNER JOIN r.idActividad a WHERE r.idContrato.idContrato = :contrato AND r.estado = 'A'")})
